...
## Weekly Confirmed, Tested, Death and Recovered
...
```{r, fig.align='center', fig.cap="Confirmed Cases and Testing"}
...
t1 <- summary_table(peru_confirmed, summary_statistics) %>% kableExtra::kable(caption = "Summary Statistics of Total COVID19 Cases in Peru") %>% kableExtra::kable_styling(c("striped", "hover"))
...
t2 <- summary_table(peru_deaths, summary_statistics) %>% kableExtra::kable(caption = "Summary Statistics of Total COVID19 Cases in Peru") %>% kableExtra::kable_styling(c("striped" , "hover"))
...
t3 <- summary_table(peru_recover, summary_statistics) %>% kableExtra::kable(caption = "Summary Statistics of Total COVID19 Cases in Peru") %>% kableExtra::kable_styling(c("striped" , "hover"))
...
t4 <- summary_table(peru_tests, summary_statistics) %>% kableExtra::kable(caption = "Summary Statistics of Total COVID19 Cases in Peru") %>% kableExtra::kable_styling(c("striped" , "hover"))
